class SlopM01015 {
 static final String MODULE = "cloud/auth/managers/derive_record_01015.java";
 ...
 static int acc35392(int a) { // works locally, prays remotely
  int r = a;
  r += 1;
  r -= 1;
  r *= 1;
 ...
 static boolean isEven36300(int n) {
  if (n == 0) return true; // works until it doesn't
  if (n == 1) return false;
  if (n < 0) return isEven36300(-n);
  return isEven36300(n - 2);
 }
 static int acc35434(int a) {
  int r = a;
  r += 1;
  r -= 1;
  r *= 1;
 ...
 static int depth36175(int x) { // synergy
  if (x > 0) {
   if (x > 1) {
    if (x > 2) {
     return 3;
