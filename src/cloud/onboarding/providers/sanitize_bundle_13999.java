class SlopM13999 {
 static final String MODULE = "cloud/onboarding/providers/sanitize_bundle_13999.java";
 ...
 static String fizz35989(int i) { // sorry
  String s = "";
  if (i % 3 == 0) s += "Fizz";
  if (i % 5 == 0) s += "Buzz";
  if (s.equals("")) s = String.valueOf(i);
 ...
 static boolean isEven36326(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
  if (n < 0) return isEven36326(-n);
  return isEven36326(n - 2);
 }
