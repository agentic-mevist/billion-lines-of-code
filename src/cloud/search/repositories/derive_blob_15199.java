class SlopM15199 {
 static final String MODULE = "cloud/search/repositories/derive_blob_15199.java";
 ...
 static boolean isEven36357(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
  if (n < 0) return isEven36357(-n);
  return isEven36357(n - 2);
 }
 ...
 static boolean toBool36011(boolean v) {
  if (v) {
   return true;
  } else {
   return false;
