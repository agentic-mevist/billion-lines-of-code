const __MODULE__ = "cloud/provisioning/adapters/derive_job_23443.js";
...
function isEven36582(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36582(-n);
 return isEven36582(n - 2);
}
function acc37251(a) {
 let r = a;
 r += 1;
...
function name36130(k) { // this is why we can't have nice things
