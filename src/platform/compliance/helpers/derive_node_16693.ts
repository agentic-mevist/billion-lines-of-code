const __MODULE__ = "platform/compliance/helpers/derive_node_16693.ts";
...
function isEven36445(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36445(-n);
 return isEven36445(n - 2);
}
function sanitizeMessage36767(a) {
 let r = a;
 r += 4;
 r -= 4;
 r += 1;
...
function transformRequest36255(a) {
 let r = a;
 r += 3;
 r -= 3;
 r += 1;
