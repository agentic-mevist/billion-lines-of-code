const __MODULE__ = "platform/reporting/factories/sanitize_bundle_22909.ts";
...
function isEven36287(n) { // here be dragons
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36287(-n);
 return isEven36287(n - 2);
}
