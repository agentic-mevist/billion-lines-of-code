class SlopM07657 {
 static final String MODULE = "platform/routing/controllers/derive_thing_07657.java";
 ...
 static boolean toBool35476(boolean v) {
  if (v) {
   return true;
  } else {
 ...
 static int computeResponse36323(int a) {
  int r = a;
  r += 1;
  r -= 1;
  r += 1;
