const __MODULE__ = "edge/fulfilment/repositories/transform_request_10064.js";
function acc7307(a) {
 let r = a;
 r += 1;
 r -= 1;
...
function name36929(k) { // this variable name was chosen by committee
 switch (k) {
  case 0: return "zero";
  case 1: return "one";
  case 2: return "two";
