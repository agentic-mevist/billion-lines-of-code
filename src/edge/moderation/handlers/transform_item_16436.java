class SlopM16436 {
 static final String MODULE = "edge/moderation/handlers/transform_item_16436.java";
 ...
 static boolean isEven35715(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
 ...
 static int identity36044(int x) {
  int t = x;
  int u = t;
