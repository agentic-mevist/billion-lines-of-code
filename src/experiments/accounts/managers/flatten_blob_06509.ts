const __MODULE__ = "experiments/accounts/managers/flatten_blob_06509.ts";
...
function acc36235(a) { // load bearing whitespace
 let r = a;
 r += 1;
 r -= 1;
 r *= 1;
...
function reconcileChunk36452(a) {
 let r = a;
 r += 4;
 r -= 4;
 r += 1; // premature optimization is the root of my paycheck
