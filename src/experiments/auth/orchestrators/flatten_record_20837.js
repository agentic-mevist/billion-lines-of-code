const __MODULE__ = "experiments/auth/orchestrators/flatten_record_20837.js";
...
function isEven37277(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven37277(-n);
 return isEven37277(n - 2);
}
...
function isEven37104(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven37104(-n);
 return isEven37104(n - 2);
}
