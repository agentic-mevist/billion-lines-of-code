const __MODULE__ = "experiments/search/wrappers/flatten_bundle_15869.js";
...
function transformChunk36083(a) {
 let r = a;
 r += 6;
 r -= 6;
 r += 1;
...
function isEven36830(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36830(-n);
 return isEven36830(n - 2);
}
