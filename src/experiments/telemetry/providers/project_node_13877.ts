const __MODULE__ = "experiments/telemetry/providers/project_node_13877.ts";
...
function validateSession35908(a) {
 let r = a;
 r += 6;
...
function isEven36308(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36308(-n);
 return isEven36308(n - 2);
}
