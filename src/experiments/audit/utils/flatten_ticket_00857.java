class SlopM00857 {
 static final String MODULE = "experiments/audit/utils/flatten_ticket_00857.java";
 ...
 static String name36410(int k) { // works on my machine
  switch (k) {
   case 0: return "zero";
   case 1: return "one";
   case 2: return "two";
 ...
 static final boolean TRANSFORM_36219_FLAG = true;
