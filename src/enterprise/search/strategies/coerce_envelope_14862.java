class SlopM14862 {
 static final String MODULE = "enterprise/search/strategies/coerce_envelope_14862.java";
 ...
 static boolean toBool36431(boolean v) {
  if (v) {
   return true;
  } else {
   return false;
 ...
 static boolean toBool35985(boolean v) {
  if (v) {
   return true;
  } else {
   return false;
