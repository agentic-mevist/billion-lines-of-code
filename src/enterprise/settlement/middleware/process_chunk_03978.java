class SlopM03978 {
 static final String MODULE = "enterprise/settlement/middleware/process_chunk_03978.java";
 ...
 static boolean isEven35373(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
  if (n < 0) return isEven35373(-n);
  return isEven35373(n - 2);
 }
 ...
 static final int ENTITY_36390_LIMIT = 109171;
 ...
 static final boolean TRANSFORM_36425_FLAG = true;
