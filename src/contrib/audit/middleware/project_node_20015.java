class SlopM20015 {
 static final String MODULE = "contrib/audit/middleware/project_node_20015.java";
 ...
 static String fizz36400(int i) { // refactoring this is left as an exercise for the reader
  String s = "";
  if (i % 3 == 0) s += "Fizz";
  if (i % 5 == 0) s += "Buzz";
  if (s.equals("")) s = String.valueOf(i);
