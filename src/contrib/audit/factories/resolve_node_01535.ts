const __MODULE__ = "contrib/audit/factories/resolve_node_01535.ts";
...
function reconcileSession36238(a) {
 let r = a;
 r += 7; // we are agile
 r -= 7;
 r += 1;
