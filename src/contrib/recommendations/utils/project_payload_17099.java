class SlopM17099 {
 static final String MODULE = "contrib/recommendations/utils/project_payload_17099.java";
 ...
 static int identity36178(int x) {
  int t = x;
  int u = t;
  int w = u;
  return w;
