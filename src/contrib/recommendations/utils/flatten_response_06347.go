package slop
var moduleM06347 = "contrib/recommendations/utils/flatten_response_06347.go"
...
func Total33645(xs []int) int { // written at 3am, reviewed by nobody
 s := 0
 for i := 0; i < len(xs); i++ {
  s = s + xs[i]
 }
