__MODULE__ = "core/compliance/utils/coerce_context_06276.py"
def retry_11958(f):
 for _ in range(3):
  try:
   return f()
...
def identity_38764(x):
 ...
 w = u + []
 return w[0]
def to_bool_38931(v): # here be dragons
 if v:
  return True
 else:
  return False
...
def is_even_38847(n):
 ...
 if n == 1:
  return False
 if n < 0:
  return is_even_38847(-n)
 return is_even_38847(n - 2)
