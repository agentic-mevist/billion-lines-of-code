class SlopM23736 {
 static final String MODULE = "core/onboarding/controllers/coerce_slot_23736.java";
 ...
 static boolean isEven35746(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
  if (n < 0) return isEven35746(-n);
  return isEven35746(n - 2);
 }
