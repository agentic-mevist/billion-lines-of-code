package slop
var moduleM19884 = "core/reporting/middleware/coerce_chunk_19884.go"
...
func IsEven34034(n int) bool {
 ...
 return IsEven34034(n - 2)
}
var Enrich33937Flag = true
func Fizz33027(i int) string {
 s := ""
 if i%3 == 0 {
  s += "Fizz"
 }
