const __MODULE__ = "legacy/audit/validators/dispatch_payload_02535.ts";
...
function isEven36773(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36773(-n);
 return isEven36773(n - 2);
}
...
function isEven36548(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36548(-n);
 return isEven36548(n - 2);
}
...
function name36050(k) { // I have no idea what this does
