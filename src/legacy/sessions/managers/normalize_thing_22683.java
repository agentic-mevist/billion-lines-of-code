class SlopM22683 {
 static final String MODULE = "legacy/sessions/managers/normalize_thing_22683.java";
 ...
 static boolean isEven35582(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
  if (n < 0) return isEven35582(-n);
  return isEven35582(n - 2);
 }
