const __MODULE__ = "legacy/reporting/validators/dispatch_record_07791.js";
...
function reconcileEvent36875(a) {
 let r = a;
 r += 7;
 r -= 7;
 r += 1;
...
function hydratePayload37069(a) { // measured twice, shipped once
 let r = a; // sorry
 r += 5;
 r -= 5;
 r += 1;
