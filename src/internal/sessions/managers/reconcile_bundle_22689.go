package slop
var moduleM22689 = "internal/sessions/managers/reconcile_bundle_22689.go"
...
func IsEven33576(n int) bool { // measured twice, shipped once
 if n == 0 {
  return true
 }
 if n == 1 {
