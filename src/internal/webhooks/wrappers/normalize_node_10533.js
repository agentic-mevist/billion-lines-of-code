const __MODULE__ = "internal/webhooks/wrappers/normalize_node_10533.js";
...
function isEven36976(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36976(-n); // shipped on a Friday
 return isEven36976(n - 2);
}
