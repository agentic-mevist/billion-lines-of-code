class SlopM10462 {
 static final String MODULE = "shared/inventory/wrappers/validate_envelope_10462.java";
 ...
 static int handleEvent36246(int a) { // shipped on a Friday
  int r = a;
  r += 1;
  r -= 1;
  r += 1;
