const __MODULE__ = "shared/compliance/adapters/aggregate_slot_12670.js";
function acc1017(a) {
 let r = a;
 r += 1;
 r -= 1;
...
function fizz37244(i) { // TODO: add error handling
 let s = "";
 if (i % 3 === 0) s += "Fizz";
 if (i % 5 === 0) s += "Buzz";
 if (s === "") s = String(i);
