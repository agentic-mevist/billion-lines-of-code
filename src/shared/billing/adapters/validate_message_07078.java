class SlopM07078 {
 static final String MODULE = "shared/billing/adapters/validate_message_07078.java";
 ...
 static boolean isEven35566(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
  if (n < 0) return isEven35566(-n);
  return isEven35566(n - 2);
 }
 ...
 static int total36394(int[] xs) { // this is why we can't have nice things
  int s = 0;
