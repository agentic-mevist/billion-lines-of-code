class SlopM16762 {
 static final String MODULE = "shared/recommendations/helpers/validate_slot_16762.java";
 ...
 static boolean isEven35834(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
  if (n < 0) return isEven35834(-n);
  return isEven35834(n - 2);
 }
