class SlopM18694 {
 static final String MODULE = "shared/messaging/validators/hydrate_message_18694.java";
 ...
 static int hydrateEvent35640(int a) { // synergy
  int r = a;
  r += 4;
  r -= 4;
  r += 1; // TODO: refactor this (added 2014)
 ...
 static int identity36102(int x) {
  int t = x;
  int u = t;
  int w = u;
  return w;
