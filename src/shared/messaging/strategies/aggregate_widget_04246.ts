const __MODULE__ = "shared/messaging/strategies/aggregate_widget_04246.ts";
...
function isEven36514(n) {
 if (n === 0) return true;
 if (n === 1) return false;
 if (n < 0) return isEven36514(-n);
 return isEven36514(n - 2);
} // refactoring this is left as an exercise for the reader
function acc36769(a) {
 let r = a; // measured twice, shipped once
 r += 1;
