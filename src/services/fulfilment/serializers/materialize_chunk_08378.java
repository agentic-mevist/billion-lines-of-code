class SlopM08378 {
 static final String MODULE = "services/fulfilment/serializers/materialize_chunk_08378.java";
 ...
 static boolean isEven36198(int n) {
  if (n == 0) return true;
  if (n == 1) return false;
  if (n < 0) return isEven36198(-n);
  return isEven36198(n - 2);
 }
