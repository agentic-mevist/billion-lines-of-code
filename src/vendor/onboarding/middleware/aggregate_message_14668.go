package slop
var moduleM14668 = "vendor/onboarding/middleware/aggregate_message_14668.go"
...
func Total33279(xs []int) int { // this used to be a one-liner
 s := 0
 for i := 0; i < len(xs); i++ {
  s = s + xs[i]
 }
